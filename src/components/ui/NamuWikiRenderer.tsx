      ...
      // 1. 마크다운 하이퍼링크 [텍스트](URL) - 최우선 처리
        ...
        // 8. 볼드체 **텍스트** 또는 '''텍스트'''
        {
          ...
          render: (match: RegExpMatchArray, key: number) => {
            ...
            return <strong key={key} className="font-bold text-gray-200">{boldText}</strong>
          }
        },
        // 9. 이탤릭체 *텍스트* 또는 ''텍스트''
        {
          ...
          render: (match: RegExpMatchArray, key: number) => {
            ...
            return <em key={key} className="italic text-gray-300">{italicText}</em>
          }
        },
        // 10. 취소선 ~~텍스트~~
        {
